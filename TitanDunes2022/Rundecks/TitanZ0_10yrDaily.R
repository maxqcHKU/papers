...
AIC=/lustre1/g/esd_kaplan/maxqc/huge_space/TitanZ0_3yrSU/1JAN1960.rsfTitanZ0_3yrSU.nc        ! New atmo initial cond for Titan 8/18/17
...
TOPO=/home/maxqc/titan_input/titan_topo_flat.nc  ! Titan topography smoothed from 1x1
...
TOP_INDEX=/home/maxqc/ModelE2_Planet_1.0/decks/titan_srfcsgma.nc   ! Titan topography std. deviations
ROUGHL=/home/maxqc/titan_input/z0m_72x46_desertworldTitanSS.nc
...
&INPUTZ
YEARI=1960,MONTHI=1,DATEI=1,HOURI=0, ! pick IYEAR1=YEARI (default) or < YEARI
YEARE=1971,MONTHE=1,DATEE=1,HOURE=0,     KDIAG=12*0,9,
ISTART=8,IRANDI=0, YEARE=1960,MONTHE=1,DATEE=1,HOURE=1,
